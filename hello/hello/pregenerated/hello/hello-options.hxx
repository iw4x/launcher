...
#ifndef HELLO_HELLO_OPTIONS_HXX
#define HELLO_HELLO_OPTIONS_HXX
...
namespace hello
{
  class options
  {
    ...
    options (int& argc,
             char** argv,
             bool erase = false,
             ::hello::cli::unknown_mode option = ::hello::cli::unknown_mode::fail,
             ::hello::cli::unknown_mode argument = ::hello::cli::unknown_mode::stop);
    ...
    print_usage (::std::ostream&,
                 ::hello::cli::usage_para = ::hello::cli::usage_para::none);

    // Implementation details.
    //
    protected:
    bool
    _parse (const char*, ::hello::cli::scanner&);

    private:
    bool
    _parse (::hello::cli::scanner&,
            ::hello::cli::unknown_mode option,
            ::hello::cli::unknown_mode argument);
...
#include <hello/hello-options.ixx>
