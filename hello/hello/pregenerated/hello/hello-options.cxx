...
namespace hello
{
  ...
  options (int& argc,
           char** argv,
           bool erase,
           ::hello::cli::unknown_mode opt,
           ::hello::cli::unknown_mode arg)
  : build2_metadata_ (),
    build2_metadata_specified_ (false),
    help_ (),
    version_ (),
  ...
  ::hello::cli::usage_para options::
  print_usage (::std::ostream& os, ::hello::cli::usage_para p)
  {
  ...
  typedef
  std::map<std::string, void (*) (options&, ::hello::cli::scanner&)>
  _cli_options_map;
  ...
  struct _cli_options_map_init
  {
    _cli_options_map_init ()
    {
      ...
      &::hello::cli::thunk< options, std::uint64_t, &options::build2_metadata_,
  ...
  bool options::
  _parse (const char* o, ::hello::cli::scanner& s)
  {
  ...
  bool options::
  _parse (::hello::cli::scanner& s,
          ::hello::cli::unknown_mode opt_mode,
          ::hello::cli::unknown_mode arg_mode)
  {
    // Can't skip combined flags (--no-combined-flags).
    //
    assert (opt_mode != ::hello::cli::unknown_mode::skip);
    ...
    while (s.more ())
    {
      ...
      if (opt)
      {
        ...
        if (std::strncmp (o, "-", 1) == 0 && o[1] != '\0')
        {
          ...
          if (const char* v = std::strchr (o, '='))
          {
            ...
            ::hello::cli::argv_scanner ns (0, ac, av);
            ...
            if (_parse (co.c_str (), ns))
            {
              ...
              //
              if (ns.end () != 2)
                throw ::hello::cli::invalid_value (co, v);
          ...
          switch (opt_mode)
          {
            case ::hello::cli::unknown_mode::skip:
            {
              s.skip ();
              r = true;
              continue;
            }
            case ::hello::cli::unknown_mode::stop:
            {
              break;
            }
            case ::hello::cli::unknown_mode::fail:
            {
              throw ::hello::cli::unknown_option (o);
            }
          }
      ...
      switch (arg_mode)
      {
        ...
        case ::hello::cli::unknown_mode::fail:
        {
          throw ::hello::cli::unknown_argument (o);
        }
      }
