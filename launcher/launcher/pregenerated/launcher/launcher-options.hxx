...
#ifndef LAUNCHER_LAUNCHER_OPTIONS_HXX
#define LAUNCHER_LAUNCHER_OPTIONS_HXX
...
namespace launcher
{
  class options
  {
    ...
    options (int& argc,
             char** argv,
             bool erase = false,
             ::launcher::cli::unknown_mode option = ::launcher::cli::unknown_mode::fail,
             ::launcher::cli::unknown_mode argument = ::launcher::cli::unknown_mode::stop);
    ...
    print_usage (::std::ostream&,
                 ::launcher::cli::usage_para = ::launcher::cli::usage_para::none);

    // Implementation details.
    //
    protected:
    bool
    _parse (const char*, ::launcher::cli::scanner&);

    private:
    bool
    _parse (::launcher::cli::scanner&,
            ::launcher::cli::unknown_mode option,
...
#include <launcher/launcher-options.ixx>
...
#endif // LAUNCHER_LAUNCHER_OPTIONS_HXX
