...
namespace launcher
{
  ...
  ::launcher::cli::usage_para options::
  print_usage (::std::ostream& os, ::launcher::cli::usage_para p)
  {
    ...
    os << "--no-connect-protocol Skip refreshing the iw4x:// protocol association." << ::std::endl;
  ...
  typedef
  std::map<std::string, void (*) (options&, ::launcher::cli::scanner&)>
  _cli_options_map;
  ...
  struct _cli_options_map_init
  {
    _cli_options_map_init ()
    {
      ...
      _cli_options_map_["--no-connect-protocol"] =
      &::launcher::cli::thunk< options, &options::no_connect_protocol_ >;
  ...
  bool options::
  _parse (const char* o, ::launcher::cli::scanner& s)
  {
  ...
  bool options::
  _parse (::launcher::cli::scanner& s,
          ::launcher::cli::unknown_mode opt_mode,
          ::launcher::cli::unknown_mode arg_mode)
  {
    // Can't skip combined flags (--no-combined-flags).
    //
    assert (opt_mode != ::launcher::cli::unknown_mode::skip);
    ...
    while (s.more ())
    {
      ...
      if (opt)
      {
        ...
        if (std::strncmp (o, "-", 1) == 0 && o[1] != '\0')
        {
          ...
          if (const char* v = std::strchr (o, '='))
          {
            ...
            ::launcher::cli::argv_scanner ns (0, ac, av);
            ...
            if (_parse (co.c_str (), ns))
            {
              ...
              //
              if (ns.end () != 2)
                throw ::launcher::cli::invalid_value (co, v);
          ...
          switch (opt_mode)
          {
            case ::launcher::cli::unknown_mode::skip:
            {
              s.skip ();
              r = true;
              continue;
            }
            case ::launcher::cli::unknown_mode::stop:
            {
              break;
            }
            case ::launcher::cli::unknown_mode::fail:
            {
              throw ::launcher::cli::unknown_option (o);
            }
          }
      ...
      switch (arg_mode)
      {
        ...
        case ::launcher::cli::unknown_mode::fail:
        {
          throw ::launcher::cli::unknown_argument (o);
        }
      }
